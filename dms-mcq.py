...
urls = ['https://www.sanfoundry.com/discrete-mathematics-questions-answers-propositions/']
...
for url in urls:
    ...
    for line in div.text.splitlines():
        if line != '' and not line.__contains__('advertisement'):
            if not line.__contains__('Next') and not line.__contains__('Prev'):
                ...
                if not line.__contains__('Sanfoundry') and not line.__contains__(
                    ...
                    'Instagram') and not line.__contains__('Discrete Mathematics'):
                    if line[0].isnumeric():
